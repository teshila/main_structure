	...
	<div class="titlebox">
		<div class="twrap">
			...
			<h1>
				...
				<c:if test="${1 == user.id}"><span style="position:relative;top:-8px;left:5px;"><a href="${basePath}/period/list" target="_blank"><img src="http://png-5.findicons.com/files/icons/1620/crystal_project/48/download_manager.png"></a></span></c:if>
				<c:if test="${1 == user.id}"><span style="position:relative;top:-8px;left:5px;"><a href="${basePath}/period/addmusic" target="_blank"><img src="${basePath}/images/add.png"></a></span></c:if>
				<c:if test="${1 == user.id}"><span style="position:relative;top:-8px;left:5px;"><a href="${basePath}/period/editmusic/${period.id}" target="_blank"><img src="${basePath}/images/edit.png"></a></span></c:if>
			</h1>
		</div>
	</div>
	<div id="warp">
		<!--封面图部分-->
			...
			<div class="musicbox">
				...
				<div class="btn-wrapper">
					<a href="javascript:;" id="prev" class="prev jp-previous" title="上一曲">
				...
				<div class="program">
					...
					<div class="tz_per percent" id="percent"></div>
				</div>
				<!-- 声音进度条 -->
				<div class="fl">
...
<script type="text/javascript">
	$(function(){
		...
		$(window).scroll(function () {
	        ...
	        if(!totalCount || totalCount <= psize){//如果总数都小于当前显示的数量，代表只有一页
	        	loaded = false;
	        	return;
	        }
