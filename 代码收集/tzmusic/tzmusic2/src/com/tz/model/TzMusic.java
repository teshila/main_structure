 ...
 */
@Entity
@Table(name = "tz_music", catalog = "tzmusic")
public class TzMusic implements java.io.Serializable {
	...
	private Integer isDelete;// 删除状态0为删除1删除
	// 期刊id
	...
	/** full constructor */
	public TzMusic(String title, String article, Date pulishTime, String timer,
	...
	@Column(name = "pulish_time", length = 0)
