...
$.tzUpload = function(options){
	...
	var settings = {
		flash_url : basePath+"/resources/upload/swfupload.swf",//指明文件上传的flash文件
		flash9_url : basePath+"/resources/upload/swfupload_fp9.swf",//新版的flash文件
...
$.tzUpload.defaults = {
	...
	single:false,
	htmlbox:"",
	img:basePath+"/resources/upload/imagebtn.png",
	reload:function(){
	...
	uploadStart:function(file){
		//设置参数 
		var path = $("#subjectdir").val();
		var dir = "";
		if(path==1)dir="java";
		if(path==2)dir="php";
		this.addPostParam("dir",dir);
